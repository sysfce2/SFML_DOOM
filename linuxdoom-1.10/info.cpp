...
state_t states[NUMSTATES] = {
    ...
    {SPR_SHTG,
     4,
     0,
     {reinterpret_cast<actionf_p1>(A_Light0)},
     S_NULL,
     0,
     0}, // S_LIGHTDONE
    {SPR_PUNG,
     0,
     1,
     {reinterpret_cast<actionf_p1>(A_WeaponReady)},
     S_PUNCH,
     0,
     0}, // S_PUNCH
    {SPR_PUNG,
     0,
     1,
     {reinterpret_cast<actionf_p1>(A_Lower)},
     S_PUNCHDOWN,
     0,
     0}, // S_PUNCHDOWN
    {SPR_PUNG,
     0,
     1,
     {reinterpret_cast<actionf_p1>(A_Raise)},
     S_PUNCHUP,
     0,
     0},                                      // S_PUNCHUP
    ...
    {SPR_PUNG,
     2,
     4,
     {reinterpret_cast<actionf_p1>(A_Punch)},
     S_PUNCH3,
     0,
     0},                                      // S_PUNCH2
    ...
    {SPR_PUNG,
     1,
     5,
     {reinterpret_cast<actionf_p1>(A_ReFire)},
     S_PUNCH,
     0,
     0}, // S_PUNCH5
    {SPR_PISG,
    ...
    {SPR_PISG,
     1,
     6,
     {reinterpret_cast<actionf_p1>(A_FirePistol)},
     S_PISTOL3,
     0,
     0},                                       // S_PISTOL2
    ...
    {SPR_PISF,
     32768,
     7,
     {reinterpret_cast<actionf_p1>(A_Light1)},
     S_LIGHTDONE,
     0,
     0}, // S_PISTOLFLASH
    {SPR_SHTG,
    ...
    {SPR_SHTG,
     0,
     7,
     {reinterpret_cast<actionf_p1>(A_FireShotgun)},
     S_SGUN3,
     0,
     0},                                     // S_SGUN2
    ...
    {SPR_SHTF,
     32769,
     3,
     {reinterpret_cast<actionf_p1>(A_Light2)},
     S_LIGHTDONE,
     0,
     0}, // S_SGUNFLASH2
    {SPR_SHT2,
    ...
    {SPR_SHT2,
     0,
     7,
     {reinterpret_cast<actionf_p1>(A_FireShotgun2)},
     S_DSGUN3,
     0,
     0},                                      // S_DSGUN2
    ...
    {SPR_SHT2,
     2,
     7,
     {reinterpret_cast<actionf_p1>(A_CheckReload)},
     S_DSGUN5,
     0,
     0}, // S_DSGUN4
    {SPR_SHT2,
     3,
     7,
     {reinterpret_cast<actionf_p1>(A_OpenShotgun2)},
     S_DSGUN6,
     0,
     0},                                      // S_DSGUN5
    ...
    {SPR_SHT2,
     5,
     7,
     {reinterpret_cast<actionf_p1>(A_LoadShotgun2)},
     S_DSGUN8,
     0,
     0},                                      // S_DSGUN7
    ...
    {SPR_SHT2,
     7,
     6,
     {reinterpret_cast<actionf_p1>(A_CloseShotgun2)},
     S_DSGUN10,
     0,
     0}, // S_DSGUN9
    {SPR_SHT2,
    ...
    {SPR_CHGG,
     0,
     4,
     {reinterpret_cast<actionf_p1>(A_FireCGun)},
     S_CHAIN2,
     0,
     0}, // S_CHAIN1
    {SPR_CHGG,
    ...
    {SPR_MISG,
     1,
     8,
     {reinterpret_cast<actionf_p1>(A_GunFlash)},
     S_MISSILE2,
     0,
     0}, // S_MISSILE1
    {SPR_MISG,
     1,
     12,
     {reinterpret_cast<actionf_p1>(A_FireMissile)},
     S_MISSILE3,
     0,
     0}, // S_MISSILE2
    {SPR_MISG,
    ...
    {SPR_SAWG,
     0,
     4,
     {reinterpret_cast<actionf_p1>(A_Saw)},
     S_SAW2,
     0,
     0}, // S_SAW1
    {SPR_SAWG,
    ...
    {SPR_PLSG,
     0,
     3,
     {reinterpret_cast<actionf_p1>(A_FirePlasma)},
     S_PLASMA2,
     0,
     0}, // S_PLASMA1
    {SPR_PLSG,
    ...
    {SPR_BFGG,
     0,
     20,
     {reinterpret_cast<actionf_p1>(A_BFGsound)},
     S_BFG2,
     0,
     0}, // S_BFG1
    {SPR_BFGG,
    ...
    {SPR_BFGG,
     1,
     10,
     {reinterpret_cast<actionf_p1>(A_FireBFG)},
     S_BFG4,
     0,
     0}, // S_BFG3
    {SPR_BFGG,
    ...
    {SPR_BFE1,
     32770,
     8,
     {reinterpret_cast<actionf_p1>(A_BFGSpray)},
     S_BFGLAND4,
     0,
     0},                                            // S_BFGLAND3
    ...
    {SPR_MISL,
     32769,
     8,
     {reinterpret_cast<actionf_p1>(A_Explode)},
     S_EXPLODE2,
     0,
     0},                                             // S_EXPLODE1
    ...
    {SPR_PLAY,
     6,
     4,
     {reinterpret_cast<actionf_p1>(A_Pain)},
     S_PLAY,
     0,
     0},                                          // S_PLAY_PAIN2
    ...
    {SPR_PLAY,
     8,
     10,
     {reinterpret_cast<actionf_p1>(A_PlayerScream)},
     S_PLAY_DIE3,
     0,
     0}, // S_PLAY_DIE2
    {SPR_PLAY,
     9,
     10,
     {reinterpret_cast<actionf_p1>(A_Fall)},
     S_PLAY_DIE4,
     0,
     0},                                           // S_PLAY_DIE3
    ...
    {SPR_PLAY,
     15,
     5,
     {reinterpret_cast<actionf_p1>(A_XScream)},
     S_PLAY_XDIE3,
     0,
     0}, // S_PLAY_XDIE2
    {SPR_PLAY,
    ...
    {SPR_POSS,
     0,
     10,
     {reinterpret_cast<actionf_p1>(A_Look)},
     S_POSS_STND2,
     0,
     0}, // S_POSS_STND
    {SPR_POSS,
    ...
    {SPR_POSS,
     0,
     4,
     {reinterpret_cast<actionf_p1>(A_Chase)},
     S_POSS_RUN2,
     0,
     0}, // S_POSS_RUN1
    {SPR_POSS,
    ...
    {SPR_POSS,
     4,
     10,
     {reinterpret_cast<actionf_p1>(A_FaceTarget)},
     S_POSS_ATK2,
     0,
     0}, // S_POSS_ATK1
    {SPR_POSS,
     5,
     8,
     {reinterpret_cast<actionf_p1>(A_PosAttack)},
     S_POSS_ATK3,
     0,
     0},                                          // S_POSS_ATK2
    ...
    {SPR_POSS,
     8,
     5,
     {reinterpret_cast<actionf_p1>(A_Scream)},
     S_POSS_DIE3,
     0,
     0}, // S_POSS_DIE2
    {SPR_POSS,
    ...
    {SPR_SPOS,
     32773,
     10,
     {reinterpret_cast<actionf_p1>(A_SPosAttack)},
     S_SPOS_ATK3,
     0,
     0},                                          // S_SPOS_ATK2
    ...
    {SPR_VILE,
     0,
     2,
     {reinterpret_cast<actionf_p1>(A_VileChase)},
     S_VILE_RUN2,
     0,
     0}, // S_VILE_RUN1
    {SPR_VILE,
    ...
    {SPR_VILE,
     32774,
     0,
     {reinterpret_cast<actionf_p1>(A_VileStart)},
     S_VILE_ATK2,
     0,
     0}, // S_VILE_ATK1
    {SPR_VILE,
    ...
    {SPR_VILE,
     32775,
     8,
     {reinterpret_cast<actionf_p1>(A_VileTarget)},
     S_VILE_ATK4,
     0,
     0}, // S_VILE_ATK3
    {SPR_VILE,
    ...
    {SPR_VILE,
     32782,
     8,
     {reinterpret_cast<actionf_p1>(A_VileAttack)},
     S_VILE_ATK11,
     0,
     0},                                               // S_VILE_ATK10
    ...
    {SPR_FIRE,
     32768,
     2,
     {reinterpret_cast<actionf_p1>(A_StartFire)},
     S_FIRE2,
     0,
     0}, // S_FIRE1
    {SPR_FIRE,
     32769,
     2,
     {reinterpret_cast<actionf_p1>(A_Fire)},
     S_FIRE3,
     0,
     0}, // S_FIRE2
    {SPR_FIRE,
    ...
    {SPR_FIRE,
     32770,
     2,
     {reinterpret_cast<actionf_p1>(A_FireCrackle)},
     S_FIRE6,
     0,
     0}, // S_FIRE5
    {SPR_FIRE,
    ...
    {SPR_FATB,
     32768,
     2,
     {reinterpret_cast<actionf_p1>(A_Tracer)},
     S_TRACER2,
     0,
     0}, // S_TRACER
    {SPR_FATB,
    ...
    {SPR_SKEL,
     6,
     6,
     {reinterpret_cast<actionf_p1>(A_SkelWhoosh)},
     S_SKEL_FIST3,
     0,
     0}, // S_SKEL_FIST2
    {SPR_SKEL,
    ...
    {SPR_SKEL,
     8,
     6,
     {reinterpret_cast<actionf_p1>(A_SkelFist)},
     S_SKEL_RUN1,
     0,
     0}, // S_SKEL_FIST4
    {SPR_SKEL,
    ...
    {SPR_SKEL,
     10,
     10,
     {reinterpret_cast<actionf_p1>(A_SkelMissile)},
     S_SKEL_MISS4,
     0,
     0}, // S_SKEL_MISS3
    {SPR_SKEL,
    ...
    {SPR_FATT,
     6,
     20,
     {reinterpret_cast<actionf_p1>(A_FatRaise)},
     S_FATT_ATK2,
     0,
     0}, // S_FATT_ATK1
    {SPR_FATT,
     32775,
     10,
     {reinterpret_cast<actionf_p1>(A_FatAttack1)},
     S_FATT_ATK3,
     0,
     0}, // S_FATT_ATK2
    {SPR_FATT,
    ...
    {SPR_FATT,
     32775,
     10,
     {reinterpret_cast<actionf_p1>(A_FatAttack2)},
     S_FATT_ATK6,
     0,
     0}, // S_FATT_ATK5
    {SPR_FATT,
    ...
    {SPR_FATT,
     32775,
     10,
     {reinterpret_cast<actionf_p1>(A_FatAttack3)},
     S_FATT_ATK9,
     0,
     0}, // S_FATT_ATK8
    {SPR_FATT,
    ...
    {SPR_FATT,
     19,
     -1,
     {reinterpret_cast<actionf_p1>(A_BossDeath)},
     S_NULL,
     0,
     0},                                            // S_FATT_DIE10
    ...
    {SPR_CPOS,
     32773,
     4,
     {reinterpret_cast<actionf_p1>(A_CPosAttack)},
     S_CPOS_ATK3,
     0,
     0}, // S_CPOS_ATK2
    {SPR_CPOS,
    ...
    {SPR_CPOS,
     5,
     1,
     {reinterpret_cast<actionf_p1>(A_CPosRefire)},
     S_CPOS_ATK2,
     0,
     0},                                          // S_CPOS_ATK4
    ...
    {SPR_TROO,
     6,
     6,
     {reinterpret_cast<actionf_p1>(A_TroopAttack)},
     S_TROO_RUN1,
     0,
     0},                                          // S_TROO_ATK3
    ...
    {SPR_SARG,
     6,
     8,
     {reinterpret_cast<actionf_p1>(A_SargAttack)},
     S_SARG_RUN1,
     0,
     0},                                          // S_SARG_ATK3
    ...
    {SPR_HEAD,
     32771,
     5,
     {reinterpret_cast<actionf_p1>(A_HeadAttack)},
     S_HEAD_RUN1,
     0,
     0},                                          // S_HEAD_ATK3
    ...
    {SPR_BOSS,
     6,
     8,
     {reinterpret_cast<actionf_p1>(A_BruisAttack)},
     S_BOSS_RUN1,
     0,
     0},                                          // S_BOSS_ATK3
    ...
    {SPR_SKUL,
     32771,
     4,
     {reinterpret_cast<actionf_p1>(A_SkullAttack)},
     S_SKULL_ATK3,
     0,
     0},                                               // S_SKULL_ATK2
    ...
    {SPR_SPID,
     0,
     3,
     {reinterpret_cast<actionf_p1>(A_Metal)},
     S_SPID_RUN2,
     0,
     0}, // S_SPID_RUN1
    {SPR_SPID,
    ...
    {SPR_SPID,
     32775,
     1,
     {reinterpret_cast<actionf_p1>(A_SpidRefire)},
     S_SPID_ATK2,
     0,
     0},                                          // S_SPID_ATK4
    ...
    {SPR_BSPI,
     0,
     3,
     {reinterpret_cast<actionf_p1>(A_BabyMetal)},
     S_BSPI_RUN2,
     0,
     0}, // S_BSPI_RUN1
    {SPR_BSPI,
    ...
    {SPR_BSPI,
     32774,
     4,
     {reinterpret_cast<actionf_p1>(A_BspiAttack)},
     S_BSPI_ATK3,
     0,
     0},                                             // S_BSPI_ATK2
    ...
    {SPR_CYBR,
     0,
     3,
     {reinterpret_cast<actionf_p1>(A_Hoof)},
     S_CYBER_RUN2,
     0,
     0}, // S_CYBER_RUN1
    {SPR_CYBR,
    ...
    {SPR_CYBR,
     5,
     12,
     {reinterpret_cast<actionf_p1>(A_CyberAttack)},
     S_CYBER_ATK3,
     0,
     0}, // S_CYBER_ATK2
    {SPR_CYBR,
    ...
    {SPR_PAIN,
     32773,
     0,
     {reinterpret_cast<actionf_p1>(A_PainAttack)},
     S_PAIN_RUN1,
     0,
     0},                                          // S_PAIN_ATK4
    ...
    {SPR_PAIN,
     32779,
     8,
     {reinterpret_cast<actionf_p1>(A_PainDie)},
     S_PAIN_DIE6,
     0,
     0},                                            // S_PAIN_DIE5
    ...
    {SPR_KEEN,
     10,
     6,
     {reinterpret_cast<actionf_p1>(A_KeenDie)},
     S_COMMKEEN12,
     0,
     0},                                          // S_COMMKEEN11
    ...
    {SPR_BBRN,
     1,
     36,
     {reinterpret_cast<actionf_p1>(A_BrainPain)},
     S_BRAIN,
     0,
     0}, // S_BRAIN_PAIN
    {SPR_BBRN,
     0,
     100,
     {reinterpret_cast<actionf_p1>(A_BrainScream)},
     S_BRAIN_DIE2,
     0,
     0},                                           // S_BRAIN_DIE1
    ...
    {SPR_BBRN,
     0,
     -1,
     {reinterpret_cast<actionf_p1>(A_BrainDie)},
     S_NULL,
     0,
     0}, // S_BRAIN_DIE4
    {SPR_SSWV,
    ...
    {SPR_SSWV,
     0,
     181,
     {reinterpret_cast<actionf_p1>(A_BrainAwake)},
     S_BRAINEYE1,
     0,
     0}, // S_BRAINEYESEE
    {SPR_SSWV,
     0,
     150,
     {reinterpret_cast<actionf_p1>(A_BrainSpit)},
     S_BRAINEYE1,
     0,
     0}, // S_BRAINEYE1
    {SPR_BOSF,
     32768,
     3,
     {reinterpret_cast<actionf_p1>(A_SpawnSound)},
     S_SPAWN2,
     0,
     0}, // S_SPAWN1
    {SPR_BOSF,
     32769,
     3,
     {reinterpret_cast<actionf_p1>(A_SpawnFly)},
     S_SPAWN3,
     0,
     0}, // S_SPAWN2
    {SPR_BOSF,
    ...
    {SPR_MISL,
     32771,
     10,
     {reinterpret_cast<actionf_p1>(A_BrainExplode)},
     S_NULL,
     0,
     0},                                         // S_BRAINEXPLODE3
